...
- [*lessOrEqual* – Проверка значения на условие "меньше либо равно"](#lessthanorequal---проверка-значения-на-условие-меньше-либо-равно)
...
#### _eachEven_ - Пропуск значений чётных вызовов
[[↑ Predicates Предикаты]](#Predicates-предикаты)
```
...
#### _nth_ - Пропуск значений кратных вызовов
[[↑ Predicates Предикаты]](#Predicates-предикаты)
```
...
#### _whereLessOrEqual_ - Проверка свойства объекта на условие "больше меньше равно"
[[↑ Predicates Предикаты]](#Predicates-предикаты)
```
...
#### _shuffle_ - Смена порядка следования элемента коллекций
[[↑ Reorganizers Преобразователи потоков]](#Reorgonizers-преобразователи-потоков)
```
