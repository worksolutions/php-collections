...
- [*ketSet* – Получение коллекции ключей карты](#получение-коллекции-ключей-карты)
...
```
Метод пару ключ/значение в объект структуры. Возвращает ``false`` если элемент не был добавлен, возможно в случае ограничений. Как ключом так и значением могут быть данные скалярных типов, массивы и объекты.
